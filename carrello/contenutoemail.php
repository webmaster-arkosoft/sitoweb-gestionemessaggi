<?php
			...
			$oggetto="Licenze di Gestione Messaggi vendute su www.gestionemessaggi.com";
			$oggetto1="Licenze di Gestione Messaggi acquistate su www.gestionemessaggi.com";
			...
			if($tipo!="Paypal"){
				...
				Grazie <strong>".utf8_decode($_POST['nome'])." ".utf8_decode($_POST['cognome'])."</strong> per aver acquistato Gestione Messaggi, il software per il mobile marketing.<br />
				...
				$prefazione1="
					...
					Grazie <strong>".utf8_decode($_POST['nome'])." ".utf8_decode($_POST['cognome'])."</strong> per aver acquistato Gestione Messaggi, il gestionale per il mobile marketing.<br /><br />
