...
?>		</script>
		...
		<form action="<?php print $secondapagina; ?>" method="POST" target="_top" >
<?php	
		//Se c'è almeno un prodotto nel carrello
		if(count($_SESSION['carrello'])>0){
?>			<div class="coupon">
				<div class="testocoupon"><img src="http://www.gestionemagazzino.info/carrello/immagini/regalo.jpg" alt="ID coupon"><div class="promozionecoupon">Attiva subito la tua <span class="promlabelcoupon">PROMOZIONE</span>: <span class="labelcoupon">(Inserisci il tuo ID-COUPON)</span></div></div>
...
?>				<div><?php if($spese=="0.00"){ print "Gratuita";}else{ print "&euro; ".$spese; } ?></div>
	...
	<div class="bottoni">
		...
		<div class="bottoneconferma">
			<input type="hidden" name="prodotto" id="prodotto" value="<?php print $_GET['prodottodb']; ?>" />
