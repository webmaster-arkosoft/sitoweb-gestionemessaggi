		...
		<div class="cd-main-content">
			...
			<div class="mex1">
				<div class="img-fondo-mex1">
					...
					<button class="md-trigger bottone" data-modal="modal-15" id="container-body">Scarica ora</button>
					...
					<div class="style-bottom">
						...
						<button class="md-trigger bottone-acquista" data-modal="modal-16" id="container-body" onclick="javascript:avviacarrello('','buffer_carrello');">Acquista
						</button>
			...
			<div class="body">
				...
				<div class="colore-fondo-body">
					<div class="header-body">
						<div class="img-gm">
							<img src="images/perche-gm.png" alt="">
							<h2>PERCH&Egrave; UTLIZZARE GESTIONE MESSAGGI?</h2>
						</div>
					</div>
				...
				<div class="clienti">
					<div class="header-clienti">
						<div class="img-clienti">
							<img src="images/clienti.png" alt="">
							<h2>I CLIENTI CHE UTLIZZANO GESTIONE MESSAGGI</h2>
						</div>
					</div>
				...
				<div class="scarica">
					<div class="header-scarica">
						<div class="img-scarica">
							...
							<h2>SCARICA LA VERSIONE DEMO DI GESTIONE MESSAGGI</h2>
						</div>
					</div>
				...
				<div class="licenza">
					...
					<div class="box-promozione">
						<img src="images/promozione.png" alt="1.000 sms gratuiti">
					</div>
