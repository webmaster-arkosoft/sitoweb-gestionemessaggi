...
<html>
	<head>
		<title>GM - Acquista crediti </title>
		<?php include "../analitycs.php"; ?>
		<link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css'>
		<link rel="stylesheet" type="text/css" href="../css/guida.css" media="screen" />
		<meta name="abstarct" content="GM - Acquista crediti"/>
		<meta name="title" content="GM - Acquista crediti" />
		<meta name="keywords" content="software da web,campagne di sms marketing,sms multipli"/>
		<meta name="description" content="GM - Acquista crediti " />
	</head>
	<body class="bodygalleria">
		<div class="generale">
			...
			<div class="boxmadre">
				<div class="boxassistenza1">
					<div class="indiceguida">
						...
						<div class="voceguida">
							<a rel="bookmark" title="Permalink a Installazione " href="installazioneGM.html#descrizioneguida"> 1. Installazione di Gestione Messaggi </a>
						</div>
						<div class="voceguida">
						...
						<div class="voceguida">
							<a rel="bookmark" title="Permalink a Acquista crediti per inviare sms" href="acquistacrediti.html#descrizioneguida"> 4.2.1 Acquisto dei Crediti </a>
						</div>
						<div class="voceguida">
							<a rel="bookmark" title="Permalink a Utilizzo del filtro per sms multipli" href="filtro.html#descrizioneguida"> 5. Utilizzo del Filtro </a>
						</div>
						<div class="voceguida">
			...
			<div id="descrizioneguida">
				<h1><a rel="bookmark" title="Permalink a Acquista crediti" href="acquistacrediti.html#descrizioneguida"> Acquisto dei Crediti </a></h1>
				<p>
				Per comprare i crediti per i vostri <strong>sms</strong> andiamo sul sito <a rel="bookmark" title="Permalink a Gestione Messaggi" href="http://www.gestionemessaggi.com">www.gestionemessaggi.com</a>, oppure 
				attraverso il pulsante "Richiedi Crediti" nella finestra Gestione Crediti e selezioniamo sul menu la voce "Acquista"...
				</p>
				
					<img src="img/homepage.jpg" alt="Home Page Gestione Messaggi" />
				
				<p>
				... e poi "Acquista Crediti" per accedere alla pagina di acquisto crediti.
				</p>
					<img src="img/homepage2.jpg" alt="Acquista Gestione Messaggi" />
				<p>
				Troverete tutte le offerte, le varie possibilit&agrave; offerte da Arkosoft per l'acquisto dei Crediti.
				</p>
			</div>
