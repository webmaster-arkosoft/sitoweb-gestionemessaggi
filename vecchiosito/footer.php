			<div class="copyright">
				...
				<div class="piva">
					...
					Fax: 0831/1815238<br />
<?php 				if($_SERVER['REQUEST_URI']=="/" or $_SERVER['REQUEST_URI']=="/index.html"){	
?>						Realizzato da <a href="http://www.arkosoft.it" title="Software House Puglia">Arkosoft</a>
<?php				}else{
						print "Realizzato da Arkosoft";
					}
?>					<br />
