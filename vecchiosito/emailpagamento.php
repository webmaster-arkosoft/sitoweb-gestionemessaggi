<?				
				...
				$oggetto="Istruzioni per acquistare la licenza d'uso di Gestione Messaggi";
				$mail="
					<html>
						<head>
						...
						<body style=\"font-family:Verdana,Tahoma,sans-serif\">
							<p>
								<center>
									<h1>Licenza d'uso di Gestione Messaggi</b></h1>
								</center>
							</p>
							Salve <b>$nome $cognome</b>,<br />
							La ringraziamo per aver effettuato l'acquistato di Gestione Messaggi.<br />
							...
							Ricevuto il pagamento provvederemo a fornirLe il seriale relativo all'ID-MACCHINA che ci ha fornito e la relativa
							fattura.<br /><br />
