<?php
	...
	if(isset($_POST['formcrediti']) and $_POST['formcrediti']=='1'){
		...
		if($errore==true){
			...
			$messaggio="<div class=\"esatto\">E' stata inviata un'email con le istruzioni per acquistare i Crediti per Gestione Messaggi all'indirizzo da Lei specificato</div>";


			//email di conferma pagamento
			include "emailpagamento1.php";	
