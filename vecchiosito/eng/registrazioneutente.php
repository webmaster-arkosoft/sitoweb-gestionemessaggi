<html>
	<head>
		<title>Gestione Messaggi registrati</title>
	...
	<body>
		<div class="generale">
			...
			<div class="header3">
				<div class="descmotto">
					<h4>Download Gestione Messaggi</h4>
					<div>
						<a href="download.html#download" title="Scarica Gestione Messaggi">Download</a> version of Gestione Messaggi for 30 days and be in it to send text messages to your customers.<br /><br />
						
						For those who do not have a phone supported by the program, <a href="crediti.html" title="Crediti Gestione Messaggi">click here</a> you can buy our SMS packages
					</div>
				</div>
			</div>
			<div class="sotto">&nbsp;</div>
			<div <?php if(strlen($messaggio)>0){ print "class='boxdownload'";}else{ print "class='boxdownload1'";} ?>>
				<div class="download" id="download">
					<div <?php if(strlen($messaggio)>0){ print "class='totaledown'";}else{ print "class='totaledown1'";} ?>>
						<div class="boxsinistra">
							<div class="titolodownload">User registration</div>
							<div class="sottotitolodownload">Fill in the following fields to register</div>
				...
				<form action="invioregistrazione.php#messaggio" method="POST" name="scarica" id="scarica" Onsubmit="javascript: return controllodownload();">
					<div class="campodownload"><div>Company Name</div></div>
					<div class="inputdownload"><input type="text" name="societa" id="societa" value="<?php print $ragionesociale; ?>" /></div>
					
					<div class="campodownload"><div>Type</div></div>
					<div class="inputdownload1">
						<select name="tipo" id="tipo">
							...
							<option value="Ditta Individuale">Individual Company</option>
						</select>
						other <input type="text" name="altro" id="altro" value="<? print $altro;?>" />
					</div>
					...
					<div class="campodownload"><div>Confirm E-mail*</div></div>
					...
					<div class="campodownload"><div>Address*</div></div>
...
La informiamo, inoltre, che il titolare del trattamento dei dati è Arkosoft, nella persona del Presidente del Consiglio di Amministrazione, domiciliato presso la sede della società  in via Casterllo 54 a San Pancrazio Salentino (Br) ,mentre il responsabile del trattamento dei dati è il Responsabile vendite clienti della divisione mercato di Arkosoft, domiciliato presso la sede della società  in via Castello,54 a San Pancrazio Salentino (Br).
					...
					<div class="checkdownload"><input type="checkbox" name="acconsento" id="acconsento" checked="checked"> I have read the Privacy Policy</div>
					<input type="hidden" name="formscarica" id="formscarica" value="1" />
					<div class="bottonescarica"><input type="image" id="cmd" name="cmd" src="immagini/registrati.jpg" /></div>
				</form>
				</div>
			</div>
			<div class="copyright">
