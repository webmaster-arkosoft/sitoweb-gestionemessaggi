		...
		<div class="generale">
					...
					<div class="mainsubmenu">
						<div class="submenu">
							...
							<div class="submenu-active2">
								<a href="buy.html" class="linksubmenu" title="Buy License">Buy License</a>
								<a href="credits.html" class="subattivo" title="Credits">Buy credits</a>
							</div>
			...
			<div class="header7">
				<div class="descmotto2">
					<h4>Buy Credits</h4>
					<div>
					There are numerous online services to send SMS using various types of gateway (the sending of the SMS server), but only our company, through the use of Gateway High Quality, guarantees perfect and rapid delivery of your message.

					By purchasing directly from us, Loans, we also guarantee the customization of the sender, regardless of the type of package purchased.					</div>
				</div>
			</div>
