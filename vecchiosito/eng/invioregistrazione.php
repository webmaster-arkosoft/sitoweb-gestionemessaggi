<?php
	...
	if(isset($_POST['formscarica']) and $_POST['formscarica']=='1'){
		...
		if($errore==true){
			...
			if($verifica==0){
				$messaggio="<div class=\"esatto\">Grazie per esserti registrato al sito di Gestione Messaggi. Le abbiamo inviato un'email per confermare la registrazione.</div>";
				...
				include "emailregistrazione.php";	
